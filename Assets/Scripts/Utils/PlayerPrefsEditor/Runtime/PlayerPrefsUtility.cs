...
namespace Sabresaurus.PlayerPrefsUtilities
{
    public static class PlayerPrefsUtility
    {
        ...
        public const string KEY_PREFIX = "RTLOL-";
        ...
        {
            return SimpleEncryption.EncryptString(key);
        }
        
        /// <summary>
        /// Checks if the specified Key exists as an encrypted key
        /// </summary>
        public static bool HasEncryptedKey(string key)
        {
            var encryptedKey = SimpleEncryption.EncryptString(key);
            return PlayerPrefs.HasKey($"{KEY_PREFIX}{encryptedKey}");
        }
        
        /// <summary>
        /// Delete the specified Key if it exists as an encrypted key
        /// </summary>
